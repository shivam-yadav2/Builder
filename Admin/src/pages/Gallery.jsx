...
const GalleryManagement = () => {
  ...
  const fetchGalleryItems = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/v1/gallery/get-all`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/v1/gallery/update`, form, config);
        setSuccess('Gallery item updated successfully');
      } else {
        const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/v1/gallery/add`, form, config);
  ...
  const handleViewItem = async (id) => {
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/v1/gallery/get-by-id`, { id });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}/api/v1/gallery/delete`,
        { id },
        {
