      ...
      <div>
          <div className="px-5 md:px-10 mt-5 pb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                  <div className="bg-[#F2FAFF] rounded-lg p-7">
                  ...
                  <div className="bg-[#004e2e] text-white rounded-lg p-7 md:p-10 flex flex-col justify-between md:col-span-2 lg:col-span-1 lg:row-span-2">
                      <div>
                          ...
                          <p className="text-sm leading-relaxed mb-10 lg:mb-20">A Strong Network of industry professionals, ensuring access to the best opportunities, resources, and partnerships for your real estate and construction projects.</p>
                      </div>
                      <Link to='/contact'>
                  ...
                  <div className="bg-[#F2FAFF] rounded-lg p-7 md:col-span-2 lg:col-span-2">
