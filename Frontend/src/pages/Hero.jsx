...
const HeroSection = () => {
  return (
    <div className="relative bg-emerald-500 overflow-hidden">
      ...
      <div className="relative z-10 pt-8 px-4 pb-6 sm:pt-12 sm:px-6 sm:pb-8 md:px-8 lg:pt-12 lg:pb-0 lg:ps-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full h-full gap-4 lg:gap-0">
          {/* Left content */}
          <div className="text-white mb-4 lg:mb-0 pr-0 lg:pr-8 flex flex-col justify-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-6 md:mb-8 leading-tight">
              Build Your<br />Dream Home
            </h1>

            <p className="text-sm sm:text-lg md:text-xl mb-5 sm:mb-8 md:mb-12 leading-relaxed opacity-90 max-w-full sm:max-w-md md:max-w-lg">
          ...
          <div className="flex items-center lg:items-end justify-center lg:justify-end">
            <div className="relative w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-full h-auto">
              <img
